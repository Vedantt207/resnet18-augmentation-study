...
![Augmentation visual comparison](https://github.com/user-attachments/assets/e12177a7-abee-493c-bc53-f4065c9b77b0)
...
![Training curves](https://github.com/user-attachments/assets/b507037e-f8f9-4543-9800-21d4c8e07394)
...
![Test accuracy comparison](https://github.com/user-attachments/assets/c5b37889-e97e-4f17-8911-7919784b8ddc)
...
```bash
git clone https://github.com/YOUR_USERNAME/cutmix-benchmark.git
cd cutmix-benchmark
...
├── augmentation_visual.jpg     # Visual comparison of augmentation methods
├── training_curves.jpg         # Validation loss and accuracy curves
├── bar_chart.jpg               # Final test accuracy comparison
└── README.md
```
